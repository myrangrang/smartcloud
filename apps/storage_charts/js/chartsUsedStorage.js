...
//       ---------------
		theLoaderID.html('<img src="'+OC.imagePath('storage_charts','loader.gif')+'" />');
		$.ajax(
			{type:'POST'
			,url:OC.linkTo('storage_charts','ajax/chartsData.php')
			,dataType:'json'
...
//		and its loadJS (app/js/settings.js)
			OC.appSettings({appid:'storage_charts',loadJS:true});
		});
//
});
