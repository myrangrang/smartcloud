...
?>
<form id="storage_charts" method="POST" action="<?php print OC_Helper::linkTo('storage_charts','charts.php'); ?>">
	<fieldset class="personalblock">
		...
		<?php foreach ( $_['displays'] as $myChart => $is_enable) {
			...
			<div><input type="checkbox" name="storage_charts_disp[]" id="<?php print $myChart; ?>_e" style="margin-right:10px;"<?php print $is_enable?' checked':'';?> value="<?php print $myChart; ?>" /><?php print $l->t($myTitle); ?></div>
		<?php } ?>
