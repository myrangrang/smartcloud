...
<?php if (OC_Util::getEditionString() === ''): ?>
	<?php /*print_unescaped($l->t('Developed by the <a href="http://103.233.157.243" target="_blank">smartCloud community</a>, the <a href="https://github.com/owncloud" target="_blank">source code</a> is licensed under the <a href="http://www.gnu.org/licenses/agpl-3.0.html" target="_blank"><abbr title="Affero General Public License">AGPL</abbr></a>.'));*/
  print_unescaped($l->t('Developed by the <a href="http://103.233.157.243" target="_blank">smartCloud community</a>, the source code is licensed under the <abbr title="Affero General Public License">AGPL</abbr>.'));?>
<?php endif; ?>
</div>
