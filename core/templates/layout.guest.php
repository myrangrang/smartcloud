		...
		<div class="wrapper"><!-- for sticky footer -->
			<div class="v-align"><!-- vertically centred box -->
              ...
              <br/><br/>
				...
				<?php endif; ?>
        <div style="margin-right: auto; margin-left: auto; width: 315px;">
				<?php print_unescaped($_['content']); ?>
        </div>
        <div style="margin-left: auto; margin-right: auto; max-width: 406px; height: 70px; margin-top: 150px;" align="center">
        <a href="http://103.233.157.243/index.php/s/BqM8mOdKahV57qg" target="_blank">
          <div id="dsktp_lnk"></div>
        </a>
        <a href="https://play.google.com/store/apps/details?id=com.smart.cloud" target="_blank" >
          <div id="andro_lnk"></div>
        </a>
