...
<!--[if !IE]><!--><html class="ng-csp" data-placeholder-focus="false" lang="<?php p($_['language']); ?>" ><!--<![endif]-->
  ...
  <!--header----------------------------------------------------------------------------------------- -->
	<header>
    <div id="header">
      <div id="frm_menu_left"></div>
			<a href="<?php print_unescaped(link_to('', 'index.php')); ?> "title="" id="smartbox" tabindex="-1">
				<div id="logo" class="logo-icon svg">
      ...
      <!--</div>-->
			...
			<div id="settings" class="svg" style="margin-top: -70px; padding: 0 15px 0 25px;">
              ...
              <?php foreach($_['navigation'] as $entry): ?>
                <li data-id="<?php p($entry['id']); ?>">
                  <a href="<?php print_unescaped($entry['href']); ?>" title=""
                    <?php if( $entry['active'] ): ?> class="active"<?php endif; ?>>
                    <div align="center">
                      <img class="app-icon svg" alt="" src="<?php print_unescaped($entry['icon']); ?>"/><br/>
  ...
  <!--header---------------------------------------------------------------------------------------- -->
    <div id="content-wrapper">
      ...
      <div id="content" style="margin-left: 60px; " class="app-<?php p($_['appid']) ?>">
