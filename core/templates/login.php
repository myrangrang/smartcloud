...
<form method="post" name="login">
    ...
    <p class="groupbottom">
      <input type="submit" id="submit" class=" bg_login" style=" position: absolute; margin-left: 260px; " value="<?php //p($l->t('Log in')); ?>" disabled="disabled"/>
    ...
    <div style="margin-top: 100px;">
		...
		<label style="color: #484848;" for="remember_login"><?php p($l->t('remember')); ?></label>
    </div>
		<?php endif; ?>
