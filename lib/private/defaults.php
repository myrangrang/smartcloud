...
class OC_Defaults {
	...
	function __construct() {
		...
		$this->defaultEntity = 'SmartCloud'; /* e.g. company name, used for footers and copyright notices */
		$this->defaultName = 'SmartCloud'; /* short name, used when referring to the software */
		$this->defaultTitle = 'SmarCloud'; /* can be a longer name, for titles */
		$this->defaultBaseUrl = 'https://103.233.157.243';
		$this->defaultSyncClientUrl = 'http://103.233.157.243/index.php/s/BqM8mOdKahV57qg'; 
		/* $this->defaultiOSClientUrl = 'https://itunes.apple.com/us/app/owncloud/id543672169?mt=8'; */ 
		//$this->defaultiTunesAppId = '543672169';
		/* $this->defaultAndroidClientUrl = 'https://play.google.com/store/apps/details?id=com.smart.cloud'; */
		$this->defaultDocBaseUrl = 'http://103.233.157.243'; 
		$this->defaultDocVersion = '1.02'; // used to generate doc links
		$this->defaultSlogan = $this->l->t('smart world in your hand');
